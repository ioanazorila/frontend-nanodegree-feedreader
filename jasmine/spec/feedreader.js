...
$(function() {
    ...
    */
    describe('RSS Feeds', function() {
         ...
         */
        it('each feed has an URL defined and not empty', function() {
    ...
    describe('The menu', function() {
        /* querySelector used to select elements from webpage because:
         * a single 'body' element on webpage
    ...
    describe('Initial Entries', function() {
        ...
        it('at least an entry is loaded into feed', function(done) {
            const firstEntry = document.querySelector('.feed .entry');
    ...
    describe('New Feed Selection', function() {
         ...
         */
        let initialEntries;     // entries after the 1st run of loadFeed function
        let newEntries;         // entries after the 2nd run of loadFeed function

        beforeEach(function(done) {
            loadFeed(0, function() {
                initialEntries = document.querySelector('.feed').innerHTML;

                // load feeds again and update list of entries
                loadFeed(1, function() {
